...
import { Display3dBuildingsComponent } from "./examples/display-3d-buildings";
...
export const demoRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'ngx-marker-cluster',
        component: NgxMarkerClusterComponent,
        data: {
          label: '[NGX] Create a clusters of html markers',
          cat: Category.CONTROLS_AND_OVERLAYS
        }
      },
      {
      ...
      {
        path: 'set-popup',
        component: AttachPopupComponent,
        data: {
