...
export declare type AllSource = MapboxGl.VectorSource | MapboxGl.RasterSource | MapboxGl.GeoJSONSource | MapboxGl.ImageSourceOptions | MapboxGl.VideoSourceOptions | MapboxGl.GeoJSONSourceRaw | MapboxGl.CanvasSourceOptions;
